    ...
    do {
        ...
        switch (aChoice) {
            ...
            case 2:
                ...
                totalBeans = rand() % 200 + 20;     // Random between 200-300
                totalWater = rand() % 200 + 65;     // Random between 200-300
                totalMilk = rand() % 190 + 15;      // Random between 150-250
                totalChocolate = rand() % 50 + 51;   // Random between 50-100
            ...
            case 3:
                {
                    ...
                    switch (coffeeChoice) {
                        case 1:
                            ...
                            printf("New price for Espresso: AED %.2f\n", espressoPrice);
                            break;
                        case 2:
                            cappuccinoPrice = newPrice;
                            printf("New price for Cappuccino: AED %.2f\n", cappuccinoPrice);
                            break;
                        case 3:
                            mochaPrice = newPrice;
                            printf("New price for Mocha: AED %.2f\n", mochaPrice);
                            break;
                    }
                }
                break;
            ...
            case 4:
                printf("Total Sales: AED %.2f\n", totalSales);
                printf("Would you like to reset total sales to zero? (1 = Yes, 0 = No): ");
                int resetChoice;
                scanf("%d", &resetChoice);

                if (resetChoice == 1) {
                    totalSales = 0;
                    printf("Total sales reset to zero. Please collect the cash from the machine.\n");
                }
                break;
