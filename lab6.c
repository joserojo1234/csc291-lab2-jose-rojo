    ...
    do {
        ...
        switch (aChoice) {
            ...
            case 2:
                ...
                totalBeans = rand() % 100 + 150;    // 150 - 249
                totalWater = rand() % 100 + 200;    // 200 - 299
                totalMilk = rand() % 100 + 150;     // 150 - 249
                totalChocolate = rand() % 50 + 50;  // 50 - 99
                ...
                // Change coffee prices
                {
                    ...
                    switch (coffeeChoice) {
                        case 1:
                            ...
                            printf("New price for the Espresso: AED %.2f\n", espressoPrice);
                            break;
                        case 2:
